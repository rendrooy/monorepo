...
import type { MasterMemberInterface } from "@monorepo/types";
...
type MemberFormProps = {
    disabled?: boolean;
    initialValues: MasterMemberInterface;
    loading?: boolean;
    onBack: () => void;
    onSubmit?: (values: MasterMemberInterface) => Promise<void> | void;
    submitText?: string;
    title: string;
};

const defaultValues: MasterMemberInterface = {
    name: "",
    nik: "",
    phone: "",
    address: "",
...
export function MemberForm({
    ...
    const formik = useFormik<MasterMemberInterface>({
        ...
        validationSchema: disabled ? undefined : memberValidationSchema,
